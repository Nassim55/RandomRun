...
const fetchRouteCoordsAfterOptimisation = async (originalMapboxRouteDistanceMeters, recalculatedPoints, dispatch, mapRef, cameraRef) => {
    try {
        ...
        await fetchFinalRouteLineString(optimisedGapCoordinates, dispatch, mapRef, cameraRef);
